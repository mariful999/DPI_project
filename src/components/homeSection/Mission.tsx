...
const Mission = () => {
  return (
    <Container className='lg:h-72'>
        <h1 className='text-3xl font-semibold text-center text-[#32a6ab]'>Mission & Vision </h1>
        <div className='p-4'>
            <h1 className='text-xl font-semibold underline underline-offset-4 text-[#32a6ab]'>Our Mission</h1>
        ...
        <div className='p-4'>
            <h1 className='text-xl font-semibold underline underline-offset-4 text-[#32a6ab]'>Our Vision </h1>
