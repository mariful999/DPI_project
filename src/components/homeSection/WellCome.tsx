...
const WellCome = () => {
  return (
    <Container className='py-28'>
      <h1 className='text-3xl font-bold py-2 text-center text-[#32a6ab]'>Welcome to Memoir Academy Ltd</h1>
        <div className=''>
            
            <div className='p-8 lg:p-0'>
                <p className='text-xl font-bold py-2 text-[#32a6ab]'>Introduction</p>
