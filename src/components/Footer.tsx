    ...
    <footer className="text-center  text-black bg-slate-400 dark:bg-neutral-700 dark:text-white/75 lg:text-left">
      <div className="flex items-center justify-center border-b-2 border-neutral-200 p-6 dark:border-white/10 lg:justify-between">
        ...
        <div className="flex justify-center">
          <Link href="https://www.facebook.com/profile.php?id=61562876453891&mibextid=JRoKGi" target='blank' aria-label="Facebook" className="me-6 flex items-center justify-center [&>svg]:h-4 [&>svg]:w-4 bg-blue-700 hover:bg-[#32a6ab] p-2">
            ...
            <p className="mb-4 flex items-center justify-center md:justify-start">
              <span className="me-3 [&>svg]:h-5 [&>svg]:w-5">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor">
                  ...
                  House-18, Road no.-2, Mohammadia Housing Society, 
                  Mohammadpur, Adabor, Dhaka-1207.
